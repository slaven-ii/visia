...
define("PARTIAL_FOLDER", 'page-templates');
...
function get_partial_path($partial){
	$file_path = TEMPLATEPATH . DIRECTORY_SEPARATOR . PARTIAL_FOLDER . DIRECTORY_SEPARATOR . $partial . ".php";
...
function get_partial($partial, $data = null, $return = false){
	$file_path = get_partial_path($partial);
